  ...
  return (
    <div className='header'>
      ...
      >
        ...
        <div style={{ display: 'inline-block', border: '2px solid #e02eaa', padding: '2px', borderRadius: '10px' }}>
        <img
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <IconButton
          onClick={() => {
            ...
            window.location.href = 'https://github.com/member1';
          }}
        >
          <GitHubIcon />
        </IconButton>
        <IconButton
          onClick={() => {
            ...
            window.location.href = 'https://linkedin.com/member1';
          }}
        >
          <LinkedInIcon />
        </IconButton>
      ...
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <IconButton
          onClick={() => {
            ...
            window.location.href = 'https://github.com/member2';
          }}
        >
          <GitHubIcon />
        </IconButton>
        <IconButton
          onClick={() => {
            ...
            window.location.href = 'https://linkedin.com/member2';
          }}
        >
          <LinkedInIcon />
        </IconButton>
